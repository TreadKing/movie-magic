				...
				<div className="container">
					<div className="hero-inner">
						<div className="hero-copy">
							...
							<p style={{color: 'white'}} className="hero-paragraph">Movie Magic is your own personalised watchlist of films you have
						...
						<div className="hero-media">
							...
							<div className="hero-media-container">
								<img className="hero-media-img" src={ film_dark }
									alt="Hero media"/>
							</div>
						</div>
					</div>
					...
					<div className="features-inner section-inner has-bottom-divider">
						<div className="features-header text-center">
							<div className="container-sm">
								...
								<p className="hero-paragraph" style={{color: 'white'}}>With Movie Magic, you can get suggestions based on the
									actors present in all your favorite film and save those recommendations for later
						...
						<div className="features-wrap">
							<div className="feature is-revealing">
								<div className="feature-inner">
									<div className="feature-icon">
										<img src={ feature_01_light }
											alt="Feature 01" />
									</div>
									<div className="feature-content">
										<h3 style={{color: 'white'}} className="feature-title mt-0">Search and Save Movies</h3>
										<p style={{color: 'white'}} className="text-sm mb-0">Find and save movies you plan to watch on a personalized
											watchlist.</p>
									</div>
								</div>
							</div>
							<div className="feature is-revealing">
								<div className="feature-inner">
									<div className="feature-icon">
										<img src={ feature_02_light }
											alt="Feature 02" />
									</div>
									<div className="feature-content">
										<h3 style={{color: 'white'}} className="feature-title mt-0">Keep up with Friends</h3>
										<p style={{color: 'white'}}  className="text-sm mb-0">Keep up with the watchlists of your friends and allow
							...
							<div className="feature is-revealing">
								<div className="feature-inner">
									<div className="feature-icon">
										<img src={ feature_03_light }
											alt="Feature 03" />
									</div>
									<div className="feature-content">
										<h3 style={{color: 'white'}} className="feature-title mt-0">Upcoming Releases</h3>
										<p style={{color: 'white'}} className="text-sm mb-0">Get an updated list of upcoming movies for your viewing.
										</p>
                                        <br /><br />
									</div>
								</div>
					...
					<div className="cta-inner section-inner">
						<div className="cta-header text-center">
							...
							<div className="cta-cta">
								<button className="button-primary" onClick={ doLogin }>Login Now</button>
							</div>
						</div>
					</div>
				</div>
